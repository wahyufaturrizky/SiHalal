...
const produkData = ref([
  {
    id: 1,
    layanan: "Makanan",
    jenis_produk: "Penyedia minuman dan makanan dengan pengolahan",
    kelas_produk: "Resto",
    rincian_produk: "Makanan Mie",
    nama_produk: "Ramen Double Spicy lvl 2",
  },
  {
    id: 2,
    layanan: "Makanan",
