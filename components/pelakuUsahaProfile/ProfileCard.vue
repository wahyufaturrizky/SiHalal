...
<template>
  <VExpansionPanels v-model="panelOpen">
    <VExpansionPanel>
      <VExpansionPanelTitle><h3>Profil</h3></VExpansionPanelTitle>
      <VExpansionPanelText>
        <VRow v-for="data in profilData" :key="data.id">
          <VCol cols="4"
            ><p>{{ data.field }}</p></VCol
          >
          <VCol cols="1"><p>:</p></VCol>
          <VCol cols="7"
            ><p>{{ data.value }}</p></VCol
          >
        </VRow>
        ...
        <VRow>
          ...
          <VCol cols="7">
            ...
            >
              <VSelect density="compact" :items="['Mikro']"></VSelect>
              <VBtn style="margin-left: 1svw" variant="outlined">Update</VBtn>
            </div>
          </VCol>
        </VRow>
        <VRow>
