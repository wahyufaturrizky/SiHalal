...
const tableHeader = [
  { title: "No", key: "no" },
  { title: t('task-force.proses-sidang.detail.section-biaya-pemeriksaan.price-detail'), key: "nama_bahan" },
  { title: t('task-force.proses-sidang.detail.section-biaya-pemeriksaan.total'), key: "nama_bahan" },
  { title: t('task-force.proses-sidang.detail.section-biaya-pemeriksaan.price'), key: "nama_bahan" },
  { title: t('task-force.proses-sidang.detail.section-biaya-pemeriksaan.sub-total'), key: "nama_bahan" }
]
  ...
  >
    <VExpansionPanel>
      <VExpansionPanelTitle><h3>
        {{ t('task-force.proses-sidang.detail.section-biaya-pemeriksaan.title') }}
