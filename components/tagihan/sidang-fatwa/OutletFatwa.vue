...
const tableHeader = [
  { title: "No", key: "no" },
  { title: t('task-force.proses-sidang.detail.section-outlet.name'), key: "nama" },
  { title: t('task-force.proses-sidang.detail.section-outlet.address'), key: "alamat" },
]
  ...
  >
    <VExpansionPanel>
      <VExpansionPanelTitle><h3>
        {{ t('task-force.proses-sidang.detail.section-outlet.title') }}
