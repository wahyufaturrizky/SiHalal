...
const tableHeader = [
  { title: "No", key: "no" },
  { title: t('task-force.proses-sidang.detail.section-auditor.name'), key: "nama_bahan" },
  { title: t('task-force.proses-sidang.detail.section-auditor.bod'), key: "nama_bahan" },
  { title: t('task-force.proses-sidang.detail.section-auditor.gender'), key: "nama_bahan" },
  { title: t('task-force.proses-sidang.detail.section-auditor.regis-no'), key: "nama_bahan" }
]
