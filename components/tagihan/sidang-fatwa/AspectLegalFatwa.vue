...
const tableHeader = [
  { title: "No", key: "no" },
  { title: t('task-force.proses-sidang.detail.section-aspek-legal.jenis'), key: "jenis_surat" },
  { title: t('task-force.proses-sidang.detail.section-aspek-legal.doc-no'), key: "no_surat" },
  { title: t('task-force.proses-sidang.detail.section-aspek-legal.date'), key: "tgl_surat" },
  { title: t('task-force.proses-sidang.detail.section-aspek-legal.expire'), key: "masa_berlaku" },
  { title: t('task-force.proses-sidang.detail.section-aspek-legal.penerbit'), key: "instansi_penerbit" }
]
