...
const tableHeader = [
  { title: "No", key: "no" },
  { title: t('task-force.proses-sidang.detail.section-nama-produk.name'), key: "reg_prod_name" },
  { title: t('task-force.proses-sidang.detail.section-nama-produk.publication'), key: "reg_publish" },
]
