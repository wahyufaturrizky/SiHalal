...
const tableHeader = [
  { title: "No", key: "no" },
  { title: t('task-force.proses-sidang.detail.section-pabrik.name'), key: "nama" },
  { title: t('task-force.proses-sidang.detail.section-pabrik.address'), key: "alamat" },
]
  ...
  >
    <VExpansionPanel>
      <VExpansionPanelTitle><h3>
        {{ t('task-force.proses-sidang.detail.section-pabrik.title') }}
