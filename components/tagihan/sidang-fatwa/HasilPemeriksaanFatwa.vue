  ...
  newData => {
    ...
    if (newData) {
      profil.value = [
        {
          id: 1,
          key: t('task-force.proses-sidang.detail.section-hasil-pemeriksaan.done-date'),
          value: getValueOrDash(newData?.sertifikat?.no_daftar),
        },
        {
          id: 2,
          key: t('task-force.proses-sidang.detail.section-hasil-pemeriksaan.result'),
          value: getValueOrDash(newData?.sertifikat?.nama_pu),
        },
        {
          id: 3,
          key: t('task-force.proses-sidang.detail.section-hasil-pemeriksaan.document'),
          value: getValueOrDash(newData?.sertifikat?.nama_pu),
        },
      ]
    }
  ...
  <VExpansionPanels v-model="paneSwitcher">
    <VExpansionPanel>
      <VExpansionPanelTitle><h2>
        {{ t('task-force.proses-sidang.detail.section-hasil-pemeriksaan.title') }}
