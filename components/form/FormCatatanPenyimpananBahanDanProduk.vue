...
const downloadCatatanBahan = item => console.log("downloadCatatanBahan ", item)
...
// TODO -> LOGIC TO DONWLOAD FILE
const downloadCatatanProduk = item => console.log("downloadCatatanProduk ", item)
...
<template>
  <VCard class="pa-4 mb-8">
    <VCardTitle class="d-flex justify-space-between align-center">
      ...
      <FormTambahCatatanBahan :is-editable="props.isEditable" @confirm="saveCatatanBahan"  @upload="uploadCatatanBahan"/>
    </VCardTitle>
    <VCardItem>
    ...
    <VCardItem>
      <VCardTitle class="d-flex justify-space-between align-center">
        ...
        <FormTambahCatatanProduk :is-editable="props.isEditable" @confirm="saveCatatanProduk"  @upload="uploadCatatanProduk"/>
      </VCardTitle>
      <VDataTable :headers="catatanProdukHeaders" :items="catatanProdukItems">
        ...
        <template #item.file="{ item }">
          <v-btn color="primary" variant="plain" prepend-icon="mdi-download" @click="downloadCatatanProduk(item)">
            File
          </v-btn>
        </template>
      </VDataTable>
