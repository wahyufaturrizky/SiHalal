...
const headers = [
  ...
  { title: 'No/Tgl Sertif Penyelia Halal', key: 'cerificateNumber', nowrap: true },
  ...
  { title: 'Action', value: 'action', sortable: false, nowrap: true, fixed: true},
]
