...
import { UPLOAD_LAPORAN_AUDIT } from "@/utils/constants";
...
onMounted(async () => {
  ...
  const responseData = await Promise.allSettled([
    loadItem(page.value, 100, searchQuery.value, UPLOAD_LAPORAN_AUDIT),
    ...
    <VCol>
      <VCard>
        <VCardTitle class="my-3 d-flex justify-space-between align-center">
          <div class="text-h4 font-weight-bold">Daftar Pengajuan</div>
        </VCardTitle>
        <VCardText>
          <VRow class="mb-4">
            <VCol cols="2">
