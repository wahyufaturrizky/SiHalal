...
const tableHeaders: any[] = [
  ...
  { title: "Provinsi Asal", key: "asal_provinsi", nowrap: true },
  { title: "Provinsi Tujuan", key: "tujuan_provinsi", nowrap: true },
...
const handleLoadList = async () => {
  try {
    const response: any = await $api("/approval/domisili-lp3h/list", {
      method: "get",
      params: {
...
<template>
  <VRow>
    <VCol>
      <h2 style="font-size: 32px">Persetujuan Pindah Domisili P3H</h2>
    </VCol>
  </VRow>
  <VRow>
    <VCol>
