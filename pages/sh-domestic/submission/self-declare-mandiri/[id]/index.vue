<template>
  <VContainer>
    <div
      ...
      @click="router.push(`/sh-domestic/submission/self-declare-mandiri`)"
    >
...
const handleDeleteSubmission = async () => {
  try {
    ...
    if (result.code === 2000) {
      ...
      router.push("/sh-domestic/submission/self-declare-mandiri");
    }
  } catch (error) {
...
const handleSentSubmission = async () => {
  try {
    ...
    if (response.code === 2000) {
      ...
      navigateTo("/sh-domestic/submission/self-declare-mandiri");
    } else {
