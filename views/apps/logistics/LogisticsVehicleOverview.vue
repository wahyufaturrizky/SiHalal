...
const vehicleData = [
  ...
  { icon: 'ri-download-2-line', title: 'Unloading', time: '3hr 15min', percentage: 28.3, color: { bg: 'rgb(var(--v-theme-primary))', text: 'rgb(var(--v-theme-on-primary))' } },
  ...
  { icon: 'ri-time-line', title: 'Waiting', time: '5hr 19min', percentage: 14.6, color: { bg: 'rgb(var(--v-tooltip-background))', text: 'rgba(var(--v-theme-surface))' } },
]
