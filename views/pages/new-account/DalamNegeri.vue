...
const checkNib = async () => {
  ...
  if (res.code !== 400) {
    ...
    try {
      ...
      if (registeredNib.value.status) buttonClicked2.value = true;
...
<template>
  ...
  >
    <VWindowItem :value="1" style="min-inline-size: 30dvw">
      <VForm ref="nibForm" @submit.prevent="onSubmitNib">
        <VCardText>
    ...
    <VWindowItem :value="2" style="min-inline-size: 50dvw">
      <VCardText>
        ...
        <VRow>
          <VCol cols="4">
            {{ t("new-domestic-nib-data.attr-1") }}
          </VCol>
          <VCol cols="8"> : {{ domesticForm?.nib }} </VCol>
        </VRow>
        <VRow>
          <VCol cols="4">
            {{ t("new-domestic-nib-data.attr-2") }}
          </VCol>
          <VCol cols="8"> : {{ domesticForm?.company_name }} </VCol>
        </VRow>
        <VRow>
          <VCol cols="4">
            {{ t("new-domestic-nib-data.attr-3") }}
          </VCol>
          <VCol cols="8">
        ...
        <VRow>
          <VCol cols="4">
            {{ t("new-domestic-nib-data.attr-4") }}
          </VCol>
          <VCol cols="8"> : {{ domesticForm?.npwp }} </VCol>
        </VRow>
        <VRow>
          <VCol cols="4">
            {{ t("new-domestic-nib-data.attr-5") }}
          </VCol>
          <VCol cols="8">
            :
        ...
        <VRow>
          <VCol cols="4">
            {{ t("new-domestic-nib-data.attr-6") }}
          </VCol>
          <VCol cols="8">
        ...
        <VRow>
          <VCol cols="4">
            {{ t("new-domestic-nib-data.attr-7") }}
          </VCol>
          <VCol cols="8">
        ...
        <VRow class="flex-row-reverse">
          <VCol cols="12" md="auto">
            <VForm @submit.prevent="submitDalamNegeri">
